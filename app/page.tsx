    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">⚔️ Excalibur</h1>
          <p className="text-gray-400 text-sm">Sistema Operacional Odontológico</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="bg-gray-900 border border-gray-800 rounded-2xl p-8 space-y-5">
          <div>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
              placeholder="clinica@email.com" required
        ...
        <p className="text-center text-gray-600 text-xs mt-6">Excalibur v0.5.0 · Multi-clínica</p>
      </div>
    </div>
  )
}

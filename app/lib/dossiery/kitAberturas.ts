  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        p: 'Corta o papo morno no meio e reancora em emoção — onde conversa vive.',
      },
      {
      ...
      },
      {
        ...
        p: 'Escassez com humor. “Última tentativa” dita o prazo — você, não ela.',
      },
      {
      ...
      },
      {
        ...
        p: 'Sumir sem drama e voltar com VALOR (não com cobrança) reseta a dinâmica.',
      },
    ],
  },
  {
    grupo: 'Reativar conversa morta / vácuo',
    desc: 'NUNCA: “sumida”, “fiz algo?”, “oi de novo”. SEMPRE: voltar com energia nova, valor novo, zero ressentimento.',
    itens: [
      {
        t: 'acabei de ver/ouvir [coisa específica] e lembrei na hora daquela sua história de [detalhe da conversa antiga]',
        p: 'Mostra memória (raro, valioso) e volta por associação — não por carência.',
      },
      {
      ...
      },
      {
        ...
        p: 'Troca justa: você dá primeiro, cobra depois — leve e simétrico.',
      },
      {
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        p: 'Elogio invertido clássico — provoca VOCÊ, exalta o pet, ela ri e responde.',
      },
      {
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        p: 'Nomeia o óbvio (o chat é limite) e age. Direto, adulto, confiante.',
      },
    ],
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        p: 'Zero cobrança, porta aberta, abundância. O oposto exato do Modo Trouxa.',
      },
      {

...
export const PROTOCOLO_ENCONTRO: FaseEncontro[] = [
  {
    ...
    jogadas: [
      ...
      },
      {
        ...
        p: 'Prova que você escuta — e transforma o encontro numa continuação natural da conversa, não num “pedido”.',
      },
      {
  ...
  },
  {
    ...
    jogadas: [
      ...
      },
      {
        ...
        p: 'Remarcação espontânea é interesse real com agenda ruim. Um crédito. O segundo bolo já é resposta — e a resposta é a Fase 1 com outra pessoa.',
      },
      {
        t: 'Desmarcou SEM nova data → “tranquilo.” E silêncio. Sem “que pena :(”, sem reagendar por ela, sem cobrar.',
    ...
    jogadas: [
      {
        ...
        p: 'Quem recebe está em casa; quem chega procurando mesa está visitando. O território é seu — ela entra no seu cenário, não o contrário.',
      },
      {
  ...
  },
  {
    ...
    objetivo: 'Sair do interrogatório e criar a sensação que ela vai lembrar: “com ele o papo simplesmente flui”.',
    jogadas: [
      {
        ...
        p: 'Pergunta de ficha gera resposta de ficha. Pergunta de história gera emoção — e ela vai associar a emoção a você, não à pergunta.',
      },
      {
        t: 'Tenha UMA história sua preparada (2 min, com começo, tensão e autozoeira). Conte quando a conversa pedir — não como palestra.',
        p: 'Vulnerabilidade dosada + humor sobre si mesmo = confiança sem arrogância. História ensaiada não é fingir: é respeitar o palco.',
      },
      {
      ...
      },
      {
        ...
        p: 'Toque no pico emocional ancora a emoção em você. Soltar rápido mostra que não é carência — é linguagem. Ela responde tocando de volta (sinal) ou não (informação).',
      },
      {
  ...
  },
  {
    ...
    jogadas: [
      ...
      },
      {
        ...
        p: 'Os 90% comunicam intenção sem palavra. Os 10% são a resposta dela — quando ela cruza, o beijo é dos dois. Isso é leitura, não sorte.',
      },
      {
        ...
        p: 'Recuo é timing, não veredito — e como você reage AO recuo é o teste real. Quem segue leve e inteiro mantém a porta aberta; quem murcha, fecha.',
      },
      {
        t: 'NUNCA: “posso te beijar?” em tom de súplica, beijo roubado sem janela, ou insistir depois de um recuo.',
        p: 'Pedir com medo entrega o frame; atropelar sinal destrói tudo — inclusive você. O jogo de quem lê é o único que ganha DE VERDADE, hoje e amanhã.',
      },
    ],
  },
  {
    ...
    jogadas: [
      ...
      {
        t: 'A conta: você convidou, você paga — sem discurso, sem “relaxa, eu faço questão”, sem olhar esperando medalha.',
        p: 'Pagar com naturalidade é frame de anfitrião. Transformar em cena é cobrar crédito — e crédito cobrado vira dívida, não atração.',
      },
      {
    ...
    jogadas: [
      {
        ...
        p: 'O callback reativa a emoção da noite em uma linha. “Chegou bem?” reativa um protocolo de tia. Você quer o riso dela, não o “cheguei sim :)”.',
      },
      {

...
export const PERFIL_MAGNETICO: GrupoPerfil[] = [
  {
    ...
    itens: [
      ...
      {
        t: 'Foto 3 (hobby em movimento): você FAZENDO algo, tipo esporte, som, cozinha, trilha, projeto. Ação acontecendo, não pose segurando equipamento.',
      ...
      {
        t: 'Foto 5 (corpo com contexto): o físico aparece dentro de cena legítima, tipo praia, futebol, natação, escalada. Nunca shirtless de espelho ou de banheiro.',
      ...
      },
      {
        ...
        p: 'Termine com pergunta, não com resposta. Curiosidade aberta é o que faz ela sair do swipe e ir fuçar o resto do seu perfil.',
      },
      {
        ...
        p: 'Ela não lê a foto, lê a intenção por trás dela: cada item dessa lista grita compensação. É o Modo Trouxa ilustrado, e insegurança farejada fecha a aba.',
      },
    ],
  },
  {
    grupo: 'Bio & Grade',
    desc: 'Bio não é currículo, é gancho. Grade é vitrine, não álbum. Juntas respondem a única pergunta que importa: como é a vida do lado desse cara?',
    itens: [
      {
      ...
      {
        t: 'Regra dos 9: os últimos 9 posts formam o mosaico que ela vê primeiro. Monte variedade de vida com você, seu mundo, sua gente, seu hobby. Zero sequência de selfie.',
      ...
      },
      {
        ...
        p: 'Highlight é o "melhores momentos" que ela assiste antes de decidir responder sua DM. É reprise jogando a seu favor, ou contra, se estiver velha e carente.',
      },
      {
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        p: 'Ela mede seu valor pelo seu entorno. Mostrar dispensa dizer: quem escreve a legenda tenta provar o que a imagem não provou sozinha.',
      },
      {
        ...
        p: 'Ângulo de baixo distorce o rosto e lê como descuido. Fotogenia aqui é questão de intenção, e intenção atrai.',
      },
      {
    ...
    itens: [
      {
        ...
        p: '"Linda" ela recebe 30 vezes por dia, é ingresso pra plateia de fãs. Comentário de conteúdo tira você da fila e abre conversa de igual pra igual.',
      },
      {
      ...
      {
        t: 'Leia quem sempre vê os SEUS: quem assiste tudo e nunca fala está investindo em silêncio. Abra você, de leve, sobre conteúdo, sem cobrar o interesse.',
    ...
    itens: [
      {
        ...
        p: '"Oi sumida" chega aos montes e morre em coro no ignorados. Mensagem com contexto prova que você viu a pessoa, não só a foto, e ela nota como isso é raro.',
      },
      {
      ...
      {
        t: 'Papo com prazo: 2-3 dias de conversa boa e proponha plano concreto, com dia e lugar ("quinta tem X ali perto, bora?").',
    ...
    itens: [
      {
        ...
        p: 'Seu histórico é seu dossiê, e ela rola até o fundo. Um post carente antigo pesa mais que dez bons de agora: parece o "você sem máscara".',
      },
      {
      ...
      },
      {
        ...
        p: 'O que postam de você e o que você comenta em público também é perfil. Comentário babão em musa é Modo Trouxa registrado, com data e testemunhas.',
      },
      {
        ...
        p: 'Você é cego pro próprio perfil: contexto demais na cabeça. O estranho vê o que ela vê, só a tela, e perfil bom sobrevive a 5 segundos de julgamento frio.',
      },
    ],
  },
]
